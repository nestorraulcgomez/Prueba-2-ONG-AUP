$(document).ready(function () {
  ...
  $("#fieldTipoContacto").change(function () {
    ...
    console.log(
      "No ha seleccionado un tipo de contacto: '" + valorIngresado + "'"
    );
  ...
  $("#fieldNombre").blur(function () {
    valorIngresado = $(this).val();
    console.log(
      "El usuario ha dejado el campo nombre con el valor: '" +
        valorIngresado +
        "'"
    );
  ...
  $("#fieldEmail").blur(function () {
    valorIngresado = $(this).val();
    console.log(
      "El usuario ha dejado el campo e-mail con el valor: '" +
        valorIngresado +
        "'"
    );
  ...
  $("#fieldFechaNacimiento").blur(function () {
    valorIngresado = $(this).val();
    console.log(
      "El usuario ha dejado el campo fechaNacimiento con el valor: '" +
        valorIngresado +
        "'"
    );
  ...
  $("#fieldRut").blur(function () {
    valorIngresado = $(this).val();
    console.log(
      "El usuario ha dejado el campo RUT vacío: + '" + valorIngresado + "'"
    );
  ...
  $("#fieldComentario").blur(function () {
    valorIngresado = $(this).val();
    console.log(
      "El usuario ha dejado el campo comentario con el valor: '" +
        valorIngresado +
        "'"
    );
